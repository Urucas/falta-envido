...
function _container(path, parent, id, callback) {
	...
	par['elements'][0].appendChild(elm);
	$('#' + elm.id).load(
		'lib/views/' + path, 
		'',
		callback
...
var Button = {
    render: function(id, desc, onclick, className, formElement ){
        /**
         * <button id="button_id" class="menuButton"><p>Description</p></button>                
         */
        var classes = [];
        ...
        button+= ' class="' + classes + '" feedback="100" >';
//        button+= '<span>';
		button+= '<span class="sp_check">';
        button+= desc;
        ...
        button+= '</span>';
		button+= '<span class="bot_check bot_check-unchecked"></span>';
...
var Text = {
    render: function(id, desc, onchange, className, label, value ){
//		alert(value);
        /**
         * <input type="text" id="text_id" class="menuText" value="valText" class='classText' value="valText" >                
         */
        var classes = [];
        ...
        if(onchange != undefined) {
			text.attr( 'onchange', onchange.toString() );
        }
